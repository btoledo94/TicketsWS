 ...
 */
package edu.miumg.gt.ticketsws.config;
...
import edu.miumg.gt.ticketsws.config.filters.CORSFilter;
import edu.miumg.gt.ticketsws.config.util.Constant;
...
@EnableJpaRepositories(
        ...
        basePackages = {"edu.miumg.gt.ticketsws"}
)
